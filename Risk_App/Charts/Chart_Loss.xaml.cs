...
namespace Risk_App
{
    public partial class Chart_LossType : Window
    {
        public Chart_LossType()
        {
            InitializeComponent();
        }
        public Chart_LossType(ChartValues<decimal> bbb, List<string> ccc, DateTime dp_begin_gr, DateTime dp_end_gr) : this()
        {
            this.bbb = bbb;
            this.ccc = ccc;
            int j = 0;
